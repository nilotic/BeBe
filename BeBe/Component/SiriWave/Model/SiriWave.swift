...
extension SiriWave {
    ...
    init(power: CGFloat) {
        self.power = power
        curves = (0..<4).map { _ in SiriCurve() }
    }
}

extension SiriWave: Identifiable {
...
extension SiriWave: Animatable {
    ...
    typealias AnimatableData = AnimatablePair<
        AnimatablePair<SiriCurve.AnimatableData, SiriCurve.AnimatableData>,
        AnimatablePair<SiriCurve.AnimatableData, AnimatablePair<SiriCurve.AnimatableData, CGFloat>>
    >
